...
class Game(object):
    ...
    def __init__(self, agents, display, rules, startingIndex=0, muteAgents=False, catchExceptions=False):
        ...
        self.output_file = open("test_othermaps_keyboard.arff", 'a')
        self.output_file.write('''@RELATION  stateData

@ATTRIBUTE living_pacman {False}
@ATTRIBUTE living_ghost1 {True, False}
...
@ATTRIBUTE ghost_dir4 {North, South, West, East, Stop}
@ATTRIBUTE ghost_dist1 numeric
@ATTRIBUTE ghost_dist2 numeric
@ATTRIBUTE ghost_dist3 numeric
